    ...
    <div className="bg-white overflow-hidden">
      ...
      >
        ...
        <div className="max-w-marketing mx-auto px-6 w-full relative z-10 my-auto lg:py-0.5">
          <div className="grid lg:grid-cols-2 gap-3 lg:gap-2 items-center">
            
            {/* Left Content */}
            <div className="max-w-xl">
              <motion.div 
                className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/5 border border-white/10 text-white/80 text-[11px] font-medium tracking-wide mb-1"
              ...
              <motion.div 
                className="flex flex-col overflow-hidden sm:flex-row gap-2 mb-1"
            ...
            <div className="relative w-full max-h-[100px] aspect-[4/3] flex items-center justify-center mt-4 lg:mt-0">
      ...
      <section className="h-[calc(100vh-72px)] flex flex-col overflow-hidden bg-warm overflow-hidden snap-start scroll-mt-[72px] justify-center" aria-label="Mobile Management">
        <div className="max-w-marketing mx-auto px-6 w-full my-auto lg:py-0.5">
          <div className="grid lg:grid-cols-2 gap-3 lg:gap-2 lg:gap-3 items-center">
            {/* Image Left */}
            <motion.div 
              className="relative w-full aspect-[4/5] max-h-[40vh] lg:max-h-[350px] flex justify-center"
              initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}
            >
              {/* Mockup Container */}
              <div className="relative w-[200px] md:w-[240px] bg-charcoal rounded-[40px] border-[12px] border-charcoal shadow-2xl overflow-hidden shrink-0 flex flex-col overflow-hidden">
            ...
            <motion.div initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
              <h2 className="font-display text-[9px] md:text-[10px] lg:text-xs text-charcoal mb-1 leading-tight font-bold">
                Manage on the go
              </h2>
              <p className="text-body text-sm md:text-xs leading-relaxed mb-0 max-w-md">
              ...
              <div className="space-y-1">
                <div className="flex items-start gap-2">
                  <div className="w-8 h-8 rounded-2xl bg-[#E8F3F1] flex items-center justify-center shrink-0 shadow-sm border border-[#D1E8E4]">
                    <Wallet className="text-primary" size={20} />
                  </div>
                  <div>
                    <h3 className="font-display font-bold text-charcoal mb-1 text-[9px] md:text-[10px]">Instant Rent Tracking</h3>
                    <p className="text-body text-[9px] md:text-[10px] leading-relaxed">See who has paid and who hasn't the second the payment hits your account.</p>
                  </div>
                </div>
                <div className="flex items-start gap-2">
                  <div className="w-8 h-8 rounded-2xl bg-[#FFF4ED] flex items-center justify-center shrink-0 shadow-sm border border-[#FFE8D6]">
                    <TrendingUp className="text-[#C75B30]" size={20} />
                  </div>
                  <div>
                    <h3 className="font-display font-bold text-charcoal mb-1 text-[9px] md:text-[10px]">Quick Financial Insights</h3>
                    <p className="text-body text-[9px] md:text-[10px] leading-relaxed">Understand cash flow instantly with visual charts optimized for mobile screens.</p>
                  </div>
                </div>
              </div>
            </motion.div>
      ...
      <section className="h-[calc(100vh-72px)] flex flex-col overflow-hidden bg-white overflow-hidden snap-start scroll-mt-[72px] justify-center" aria-label="Landlord Features">
        <div className="max-w-marketing mx-auto px-6 w-full my-auto">
          <div className="grid lg:grid-cols-2 gap-2 lg:gap-2 items-center">
            {/* Image Box */}
            <motion.div 
              className="relative w-full h-[120px] md:h-[160px] lg:h-[25vh] lg:max-h-[180px] bg-warm rounded-2xl lg:rounded-3xl overflow-hidden shadow-2xl border border-charcoal/5"
              initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}
            >
              <img 
            ...
            <motion.div 
              initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}
            >
              <h2 className="font-display text-sm md:text-xs text-charcoal mb-1 leading-tight">
                Manage all your properties in one place
              </h2>
              <p className="text-body text-[9px] md:text-[10px] mb-1 leading-relaxed max-w-lg">
              ...
              <ul className="space-y-1 lg:space-y-3">
                {['No hidden setup fees.', '100% data security. Guaranteed.', 'No training or maintenance needed.'].map((item, i) => (
                  <li key={i} className="flex items-center gap-3 text-[9px] md:text-[10px] text-charcoal font-medium">
        ...
        <div className="max-w-marketing mx-auto px-6 w-full my-auto">
          <div className="grid lg:grid-cols-2 gap-2 lg:gap-2 items-center">
            ...
            >
              ...
              <Button 
                variant="outline" 
                className="border-charcoal text-charcoal hover:bg-charcoal hover:text-white rounded-full px-5 py-2 text-[9px] md:text-[10px] h-auto"
            ...
            {/* Image Box */}
            <motion.div 
              className="relative order-1 lg:order-2 w-full h-[120px] md:h-[160px] lg:h-[25vh] lg:max-h-[180px] bg-white rounded-2xl lg:rounded-3xl border border-border overflow-hidden shadow-2xl"
              initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}
            >
              <img 
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-3">
            ...
            >
              <div className="relative z-10 max-w-lg">
                <h2 className="font-display text-[9px] md:text-[10px] lg:text-xs mb-1 leading-tight text-white font-bold">
            ...
            >
              ...
              <div>
                <h3 className="font-display font-bold text-sm md:text-xs mb-1">Easy Invoicing & Receipts</h3>
            ...
            {bentoFeatures.slice(1).map((feature, idx) => (
              ...
              >
                ...
                <div>
                  <h3 className="font-display font-bold text-sm md:text-xs mb-1">{feature.title}</h3>
...
{/* ─── Engineered for Operations ─── */}
      <section className="h-[calc(100vh-72px)] flex flex-col overflow-hidden bg-warm overflow-hidden snap-start scroll-mt-[72px] justify-center" aria-label="Engineered for Operations">
        <div className="max-w-marketing mx-auto px-6 w-full my-auto lg:py-0.5">
          ...
          >
            <h2 className="font-display text-sm text-charcoal mb-1 font-bold">
              Engineered for Operations
            </h2>
            <p className="text-body text-sm md:text-xs">
              A comprehensive suite to power your property operations and simplify management at scale.
            </p>
          </motion.div>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-2 lg:gap-2">
            {[
              ...
              <motion.div 
                key={idx}
                className="bg-white rounded-[20px] p-3 lg:p-4 border border-border shadow-sm hover:shadow-lg transition-all"
                initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: idx * 0.1 }}
              >
                <div className="w-10 h-10 rounded-xl bg-warm border border-border flex items-center justify-center mb-1">
                  <feature.icon size={18} className="text-primary" />
                </div>
                <h3 className="font-display font-bold text-sm mb-1 text-charcoal">{feature.title}</h3>
                <p className="text-body text-[9px] md:text-[10px] leading-relaxed">{feature.desc}</p>
              </motion.div>
            ))}
          </div>
        </div>
...
{/* ─── Visual Maintenance Routing ─── */}
      <section className="h-[calc(100vh-72px)] flex flex-col overflow-hidden bg-white overflow-hidden snap-start scroll-mt-[72px] justify-center" aria-label="Maintenance">
        <div className="max-w-marketing mx-auto px-6 w-full my-auto lg:py-0.5">
          <div className="grid lg:grid-cols-2 gap-2 lg:gap-3 items-center">
            {/* Left Box */}
            <motion.div 
              className="bg-warm rounded-[24px] p-3 lg:p-4 overflow-hidden relative"
              initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}
            >
              <h2 className="font-display text-sm md:text-xs lg:text-sm text-charcoal mb-1 font-bold leading-tight">
                Visual Maintenance Routing
              </h2>
              <p className="text-body text-sm md:text-xs leading-relaxed mb-1 max-w-sm">
                Drag-and-drop workflow builder. Set up rules and triggers to auto-assign maintenance issues.
              </p>

              {/* UI Mockup boxes */}
              <div className="flex flex-col overflow-hidden gap-2 relative z-10">
            ...
            <div className="flex flex-col overflow-hidden gap-2">
              ...
              >
                ...
                <h3 className="font-display font-bold text-xs mb-1 relative z-10">Auto-routing</h3>
                <p className="text-white/80 text-sm leading-relaxed mb-1 relative z-10 max-w-sm">
              ...
              <motion.div 
                ...
                initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.1 }}
              >
                <h3 className="font-display font-bold text-xs mb-1">Zero Service Motion</h3>
                <p className="text-white/80 text-sm leading-relaxed mb-1 max-w-sm">
      ...
      <section className="h-[calc(100vh-72px)] flex flex-col overflow-hidden bg-warm overflow-hidden snap-start scroll-mt-[72px] justify-center" aria-label="Integrations">
        <div className="max-w-marketing mx-auto px-6 w-full my-auto lg:py-0.5 text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            ...
            <p className="text-body text-sm md:text-xs max-w-xl mx-auto mb-1">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
            {[
              ...
              <motion.div 
                ...
                initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: idx * 0.1 }}
              >
                <div className="w-8 h-8 bg-warm rounded-full flex items-center justify-center mb-1 border border-border">
            ...
            <div className="divide-y divide-border">
              {[
                ...
                <div key={idx} className="grid grid-cols-3 p-1 items-center gap-1 hover:bg-white transition-colors">
                  <div className="font-bold text-charcoal text-[9px] md:text-[10px]">{row.feature}</div>
                  <div className="flex items-center gap-1 text-body text-[9px] md:text-[10px]">
                  ...
                  <div className="flex items-center gap-1 text-primary font-bold text-[9px] md:text-[10px]">
            ...
            <div className="grid lg:grid-cols-2 gap-2 lg:gap-3 items-center">
              ...
              <div className="flex justify-center lg:justify-end">
                <div className="bg-white rounded-[24px] p-4 border border-border shadow-xl w-full max-w-sm text-center">
                  <div className="w-16 h-16 mx-auto bg-primary rounded-full flex items-center justify-center mb-1 shadow-lg shadow-primary/20">
                    <Shield className="text-white" size={28} />
                  </div>
                  <h3 className="font-display font-bold text-sm text-charcoal mb-1">Highly Secure</h3>
...
{/* ΓöÇΓöÇΓöÇ Timeline ΓöÇΓöÇΓöÇ */}
      <section className="relative h-[calc(100vh-72px)] flex flex-col overflow-hidden bg-charcoal text-white overflow-hidden snap-start scroll-mt-[72px] justify-center" aria-label="Steps Timeline">
        <div className="max-w-marketing mx-auto px-6 relative z-10 w-full my-auto">
          <motion.div 
            className="max-w-3xl mb-1 lg:mb-1"
            initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
          >
            <h2 className="font-display text-[9px] md:text-[10px] lg:text-xs mb-1 leading-tight text-white">
              The 4 steps route to better rental management. <span className="text-white/50">Smarter renting for faster growth.</span>
            </h2>
          </motion.div>

          <div className="grid md:grid-cols-4 gap-3 lg:gap-2 mt-4 lg:mt-2">
            {steps.map((step, index) => (
              ...
              >
                <div className="w-8 h-8 lg:w-10 lg:h-10 rounded-full bg-primary/20 border border-primary/30 flex items-center justify-center mb-3 lg:mb-1">
                  <span className="text-primary font-display font-bold text-xs lg:text-sm">{step.num}</span>
                </div>
                <h3 className="font-display text-[9px] md:text-[10px] mb-1">{step.title}</h3>
...
{/* ΓöÇΓöÇΓöÇ Testimonials ΓöÇΓöÇΓöÇ */}
      <section className="h-[calc(100vh-72px)] flex flex-col overflow-hidden bg-white overflow-hidden snap-start scroll-mt-[72px] justify-center" aria-label="Testimonials">
        <div className="max-w-marketing mx-auto px-6 text-center w-full my-auto">
          <motion.h2 
            className="font-display text-[9px] md:text-[10px] lg:text-xs text-charcoal mb-1 max-w-2xl mx-auto leading-tight"
            initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
          >
            ...
            {testimonials.map((t, idx) => (
              ...
              >
                ...
                <div className="relative z-10 mb-1">
                  ...
                  <p className="text-[#a0a3a2] text-[9px] md:text-[10px] leading-relaxed font-body">
                    {t.quote}
                  </p>
                </div>
...
{/* ─── Latest Insights ─── */}
      <section className="h-[calc(100vh-72px)] flex flex-col overflow-hidden bg-warm overflow-hidden snap-start scroll-mt-[72px] justify-center" aria-label="Insights">
        <div className="max-w-marketing mx-auto px-6 w-full my-auto lg:py-0.5">
          <div className="flex flex-col overflow-hidden md:flex-row justify-between items-end mb-3 md:mb-1">
            <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
              <h2 className="font-display text-sm md:text-xs lg:text-sm text-charcoal mb-1 font-bold">
                Latest Insights
              </h2>
          ...
          <div className="grid md:grid-cols-3 gap-2">
            {[
              ...
              <motion.div 
                ...
                initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: idx * 0.1 }}
              >
                <div className="w-full aspect-[21/9] lg:aspect-[21/9] rounded-2xl mb-1 overflow-hidden bg-warm shadow-md group-hover:shadow-xl transition-all duration-500">
...
{/* ─── Common Questions ─── */}
      <section className="h-[calc(100vh-72px)] flex flex-col overflow-hidden bg-white overflow-hidden snap-start scroll-mt-[72px] justify-center" aria-label="FAQ">
        <div className="max-w-marketing mx-auto px-6 w-full my-auto lg:py-0.5">
          <motion.div className="text-center mb-1" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            <h2 className="font-display text-sm text-charcoal mb-1 font-bold">
              Common Questions
            </h2>
            <p className="text-body text-sm md:text-xs">
            ...
            {faqs.map((faq, idx) => (
              ...
              >
                <div className="flex justify-between items-start gap-2">
                  <h3 className="font-display font-bold text-charcoal text-[9px] md:text-[10px]">{faq.q}</h3>
        ...
        <div className="max-w-marketing mx-auto px-6 w-full my-auto lg:py-0.5">
          <div className="bg-gradient-to-br from-charcoal to-[#1A1D1C] rounded-2xl p-3 lg:p-4 text-center text-white relative overflow-hidden shadow-2xl">
            ...
            <div className="relative z-10 max-w-2xl mx-auto">
              <h2 className="font-display text-sm md:text-sm mb-1 leading-tight text-white">
                Ready to transform your property management?
              </h2>
              <p className="text-sm md:text-xs text-white/80 mb-1 leading-relaxed">
...
{/* ─── Final CTA ─── */}
      <section className="py-1 lg:py-0 flex flex-col overflow-hidden bg-white" aria-label="Call to Action">
        <div className="max-w-marketing mx-auto px-6 w-full my-auto lg:py-0.5 text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            <h2 className="font-display text-[9px] md:text-[10px] lg:text-xs font-bold text-charcoal mb-1 leading-tight tracking-tight max-w-3xl mx-auto">
              Stop Tracking Rent in Notebooks.
            </h2>
            <p className="text-body text-[9px] md:text-[10px] mb-3 max-w-2xl mx-auto">
              Join thousands of modern landlords across Africa using RentFlow to save time, reduce stress, and grow their portfolios.
            </p>
            <div className="flex flex-col overflow-hidden sm:flex-row gap-2 justify-center">
